namespace SDK
{
    ...
    public class JczLmc
    {
        ...
        [DllImport(
            "MarkEzd",
            EntryPoint = "lmc1_GetPrevBitmap3",
            CharSet = CharSet.Unicode,
            CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr GetPrevBitmap3(int nbmpwidth, int nbmpheight,
                                                    double dLogOriginX, double dLogOriginY,
                                                    double dLogScale);
        public static Image GetCurPreviewImage3(int nbmpwidth, int nbmpheight,
                                               double dLogOriginX, double dLogOriginY,
                                               double dLogScale)
        {
            IntPtr pBmp = GetPrevBitmap3(nbmpwidth,
                nbmpheight,
                dLogOriginX, 
                dLogOriginY, dLogScale);
